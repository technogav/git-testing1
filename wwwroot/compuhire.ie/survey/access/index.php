...
/*
   ...
   +------------------------------------------------------------------------------+
*/
if(!isset($_COOKIE['compuhireProxy'])) 
	echo "<script> document.location='http://www.compuhire.ie/survey/index.php?logout=1';</script>";
...
else
{
    ...
    {
        $_url_form      = '<div id="compuhireProxyPanel" style="width:100%;height:30px;text-align:left;margin:auto;margin:0px;border-bottom:1px solid #725554;color:#000000;background-color:#ededef;font-size:12px;font-weight:bold;font-family:Bitstream Vera Sans,arial,sans-serif;padding: 5px 0px 0px 25px;display: block;z-index:1000;">'
                        . '<form method="post" action="' . $_script_url . '">'
                        . ' <label for="____' . $_config['url_var_name'] . '"><a href="#">Address</a>:</label> <input id="____' . $_config['url_var_name'] . '" type="text" size="100" name="' . $_config['url_var_name'] . '" value="' . $_url . '" />'
                        . ' <input type="submit" name="go" value="Go" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                        . ' <input type="button" name="EXIT" value="EXIT" onclick="if (confirm(\'Are you sure you wish to Exit?\')) document.location=\'http://www.compuhire.ie/survey/index.php?logout=1\'"/>';
